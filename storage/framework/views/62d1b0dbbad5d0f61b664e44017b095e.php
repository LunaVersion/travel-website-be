        ...
        <div class="main">
            <div class="content">
                <div class="container">
                    <div class="row">
                        <div class="col-8">
                            <?php if(isset($content['paragraphs'])): ?>
                                <?php $__currentLoopData = $content['paragraphs']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $paragraph): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <p><?php echo e($paragraph); ?></p>
                                    <?php if($index == 0): ?>  <!-- Hiển thị hình ảnh tại chỉ mục 1 -->
                                        <img src="<?php echo e(asset($currentVersion['image'])); ?>" alt="Article Image">
                                    <?php endif; ?>
...
</html><?php /**PATH D:\lavarels\news\resources\views/templates/detail.blade.php ENDPATH**/ ?>