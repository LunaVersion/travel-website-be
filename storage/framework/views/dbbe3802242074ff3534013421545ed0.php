...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/headerandfooter.css')); ?>">
</head>
...
<body>
    <div class="wrapper">
        <div class="navbar">
            <div class="brand">
                <a href="<?php echo e(url('home')); ?>">travelaja</a>
            </div>
            <div class="menus" style="margin-bottom: 14px;">
                <ul>
                    <li><a href="<?php echo e(url('home')); ?>">Home</a></li>
                    <li><a href="<?php echo e(url('detail')); ?>">Discover</a></li>
                    <li><a href="<?php echo e(url('services')); ?>">Services</a></li>
                    <li><a href="<?php echo e(url('index')); ?>">News</a></li>
                    <li><a href="<?php echo e(url('aboutus')); ?>">About Us</a></li>
                    <li><a href="<?php echo e(url('contact')); ?>"><b style="color: #43B97F;">Contact</b></a></li>
                </ul>
            </div>
            <div class="language">
                <div class="dropdown">
            ...
            <div class="container">
                <div class="category-menu">
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('templates.index', ['category_id' => $id])); ?>" class="<?php echo e($id == $categoryId ? 'active' : ''); ?>">
                            <?php echo e($name); ?>
                ...
                <div class="row">
                    <?php $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="card">
                                <img src="<?php echo e(asset($currentVersion['image'])); ?>" class="card-img-top">
                                <div class="card-body">
                                    <a href="<?php echo e(route('templates.showdetail', ['slug' => $currentVersion['slug']])); ?>" class="card-title"><?php echo e($currentVersion['title']); ?></a>
                                    <p class="card-text"><?php echo e(\Carbon\Carbon::parse($currentVersion['time'])->format('F j, Y')); ?></p>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH D:\lavarels\news\resources\views/templates/index.blade.php ENDPATH**/ ?>